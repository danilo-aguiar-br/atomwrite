...
- **700+ tests listed (v0.1.30 working tree) across 63+ test suites** (unit + integration + snapshot + property-based + signal + tracing + NDJSON + regression + cross-compile + concurrency)
